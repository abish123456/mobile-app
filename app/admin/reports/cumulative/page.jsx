    ...
    <div className="space-y-6 w-full pb-10">
      <Card className="border border-slate-200 shadow-sm bg-white">
        <CardHeader className="border-b flex flex-col xl:flex-row xl:items-center justify-between gap-4 py-4 print:hidden">
          <CardTitle className="text-lg font-semibold text-slate-800 shrink-0">Cumulative Report</CardTitle>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20 bg-white">
              ...
              <p className="text-gray-500 text-sm font-medium">Generating cumulative data...</p>
            </div>
          ) : (
            <>
